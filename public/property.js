...
function renderSlider(imageNames) {
    ...
    holdImg.innerHTML = sliderImages.map(src =>
        `<div class="img"><img src="${src}" alt="Property image" onerror="this.src='icon/home icon.png'"></div>`
    ).join('');
...
window.goToSlide = function(i) {
    sliderIndex = i;
    $('holdImg').style.transform = `translateX(-${sliderIndex * 100}%)`;
    updateCounter();
};
